function [ allRe, allFe, allLe ] = goCreateNonlinearElementMatrices(problem, allUe)
...
% vectors and location vectors
    ...
    for iElement = 1:nElements
        ...
        [ allRe{iElement}, allFe{iElement} ] = nonlinearSystemMatricesCreator(problem, iElement, Ue);
