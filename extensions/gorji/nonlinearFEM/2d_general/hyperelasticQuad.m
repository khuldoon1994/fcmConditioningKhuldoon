...
% assing nonlinear system matrices creators
elementType1.nonlinearSystemMatricesCreator = @nonlinearSystemMatricesCreator;
elementType2.nonlinearSystemMatricesCreator = @nonlinearBoundarySystemMatricesCreator;
...
problem.elementNodeIndices = {
    ...
    [ 1 2 ]        % needed for penalty constraint 
    [ 2 4 ]        
};
...
% main
[ allKTe, allRe, allLe ] = goCreateNonlinearElementMatrices( problem, allUe );

[ KT, R ] = goAssembleSystem(allKTe, allRe, allLe);
...
[ allKe, allFe, allLe ] = goCreateNonlinearElementMatrices( problem, allUe );
