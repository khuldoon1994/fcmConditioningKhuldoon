...
problem.name = 'Test: Adaptive-Gauss-Legendre 1d';
...
E=1.0; A=1.0;
levelSet =@(x) x - 1.0;
elementType1 = poCreateFCMElementTypeLine1d( {'physicalDomain', levelSet,'adaptiveGaussLegendre', 2*pA, 'depth', 3, 'alphaFCM', 1.0E-06, 'youngsModulus', 1.0, 'area', 1.0 } );
...
plotAdaptiveGaussLegendre1d( problem, 3 )
